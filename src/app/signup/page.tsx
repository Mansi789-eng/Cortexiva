...
function SignupFallback() {
  return (
    <div className="w-full max-w-md animate-pulse">
      <div className="text-center mb-8">
        <div className="w-10 h-10 rounded-xl bg-gray-200 mx-auto" />
        <div className="h-8 w-48 bg-gray-200 rounded mt-6 mx-auto" />
        <div className="h-4 w-64 bg-gray-100 rounded mt-2 mx-auto" />
      </div>
      <div className="bg-white border border-gray-200 rounded-2xl p-8">
        <div className="h-12 bg-gray-100 rounded-xl" />
        <div className="h-4 w-8 bg-gray-100 rounded mx-auto my-6" />
